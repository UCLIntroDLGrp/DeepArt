...
def generate_cropped_training_and_test_data(directory_path, crop_dimensions, number_of_crops, test_size, train_size, image_selection_percent=10):
    '''
        Arguments:
        directory_path: the path for where image directories exist
        crop_dimensions: the dimensions of the cropping window
        ...
        '''
            X_train, X_test, y_train, y_test = generate_training_and_test_data(directory_path, test_size, train_size, image_selection_percent)
